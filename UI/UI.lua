...
-- ==============================================================================
-- ICON ENGINE (Embedded High-Performance Registry & Multi-Set Resolver)
-- 100% Reliable • 0ms Startup • Verified Roblox Asset IDs • Smart Alias Resolver
-- ==============================================================================
local BuiltinIcons = {
    -- Navigation & Controls
